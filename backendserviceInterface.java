...
class webServer implements Login , authenticate{//creating a class using multiple interfaces 
    ...
    /*public webServer (String email , String password) {//wanted to use but realised that using scanner you can skip this constructor
        this.EmailID = email;
...
public class backendserviceInterface{//main class
